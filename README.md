...
The resulting outputs are ready to be passed to metashape which is accessed via the python API and batch processed using the initial metadata spreadsheet. The metashape script exports an rgb orthomosaic, spectrally calibrated reflectance data, a DEM and surface elevation model
